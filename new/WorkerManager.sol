...
contract WorkerManager is IWorkerManager, FuelRetriever, Ownable, Pausable {
    ...
    */
    ...
    /*
     * Swap worker from Busy to Available workers, only allowed by the contract itself
     * @param _worker worker address
     */
    ...
    /*
     * Remove from both Available and Busy workers, only allowed by the contract itself
     * @param _worker worker address
     */
    ...
    /* 
        @notice Push worker in the Logoff workers (internal), only allowed by the contract itself
        * @param _worker worker address
    */
     ...
     */
    function getAvailableWorkersLength() public view returns(uint256) {
    ...
    */  
    function getBusyWorkersLength() public view returns(uint256) {
        return busyWorkers.length;
    }
